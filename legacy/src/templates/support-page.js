...
const iframeAdhesion = `<iframe id="haWidget" allowtransparency="true" src="https://www.helloasso.com/associations/amelie-la-vie/adhesions/adherer-a-l-association-pour-2026/widget-bouton" style="width:185px; height:70px; border:none;"></iframe>`;
